...
src_install() {
	...
	dodir /etc/env.d
	echo 'CONFIG_PROTECT_MASK="${EPREFIX}/etc/texmf/web2c ${EPREFIX}/etc/texmf/language.dat.d ${EPREFIX}/etc/texmf/language.def.d ${EPREFIX}/etc/texmf/updmap.d"' > "${ED}/etc/env.d/98texlive"
	# populate /etc/texmf
	...
	rm -f "${ED}${TEXMF_PATH}/web2c/updmap.cfg"
